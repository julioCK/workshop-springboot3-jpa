...
public interface UserRepository extends JpaRepository<User, Long> {
						...
						/*
						 * Toda interface que extender JpaRepository contara com os metodos da mesma, e
						 * NÃO É NECESSARIO implementar explicitamente os metodos de JpaRepository, pois
						 * o spring fica responsável por isso em tempo de execução.
						 * 
						 * Para extender JpaRepository é necessario fornecer o tipo da classe do
						 * repositório e o tipo do ID (chave primária da entidade/tabela).
						 */
